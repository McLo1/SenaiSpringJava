...
public class LivrosController {
    ...
    public ResponseEntity<Map<String,Object>> salvar(@Valid @RequestBody Livros livros){
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(Map.of("mensagem: " + livros.getTitulo(),"Salvod com sucesso"));
    }
    ...
    public ResponseEntity<Map<String,Object>> excluir(@PathVariable String titulo) {
        livrosServices.excluir(titulo);
        return ResponseEntity.status(HttpStatus.CREATED)
